...
#pytest test2_1.py test2_2.py test2_3.py test2_4.py test2_5.py  -n 5
...
class Sisia(unittest.TestCase):
    ...
    #ok Listo
    def test04_calendarizacion(self):
        driver = self.driver
        driver.get(ruta)
        f = Funciones(driver)
        fe = Funexcel(driver)
